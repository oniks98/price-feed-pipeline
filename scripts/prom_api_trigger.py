...
Статус імпорту:
  ...
  prom_status.py і потрапляє в data-latest разом з merged.csv через amend.
  Наступний run читає цей статус в merge_pending.py і при failed об'єднує
