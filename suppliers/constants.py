...
# =============================================================================
# FALLBACK КІЛЬКОСТІ (Rozetka: категорії без реальних залишків від постачальника)
# =============================================================================
# Постачальники не дають точну кількість, поки залишок не впаде нижче ~10 —
# до того часу availability_service.py / lp_quickproduction_service.py (та
# аналогічні сервіси інших постачальників) пишуть цей плейсхолдер замість
# реального числа. Категорії, цінові тіри та сама логіка фоллбека —
# data/markets/rozetka_fallback_qty.csv + services/stock_fallback.py
# (не тут: список категорій росте і редагується без деплою, ключ по
# категорії Prom/Rozetka, спільний для всіх постачальників).
# =============================================================================

PLACEHOLDER_QTY: Final[str] = "1000"
